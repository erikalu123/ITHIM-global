...
print_pif_table(io$bogota$outcomes$mmets, censor_method = "WHO-DRL", plot_tile = "PIF for cycling/bus with censor point at 17.5 MMET hours per week")
...
print_pif_table(io$bogota$outcomes$mmets, censor_method = "WHO-QRL", plot_tile = "PIF for cycling/bus with censor point at 35 MMET hours per week")
...
print_pif_table(io$bogota$outcomes$mmets, censor_method = "none", plot_tile = "PIF for cycling/bus with no censor point")
